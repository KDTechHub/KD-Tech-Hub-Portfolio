...
const Experience = () => {
	return (
		<div className="min-h-screen pt-16 sm:pt-20 px-4 max-w-5xl mx-auto pb-16 sm:pb-20">
			<ScrollAnimation>
				<h1 className="text-3xl sm:text-4xl font-bold mb-8 sm:mb-12 gradient-text flex items-center gap-3">
					<Briefcase className="w-7 h-7 sm:w-8 sm:h-8" />
					My Professional Experience & Career Journey
				</h1>
			</ScrollAnimation>
			
						<ScrollAnimation>
				<p className="text-gray-400 mb-12 max-w-2xl">
					Discover my career path, key roles, and achievements across tech entrepreneurship, full-stack development, software engineering, and digital innovation. See how my skills and experience have shaped the projects and businesses I built.
				</p>
			</ScrollAnimation>
