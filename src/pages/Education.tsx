		...
		<div className="min-h-screen pt-20 px-4 max-w-6xl mx-auto pb-20">
			<ScrollAnimation>
				...
				>
					...
					<h1 className="text-4xl font-bold gradient-text">Education & Continuous Learning Journey</h1>
				</motion.div>
			</ScrollAnimation>
			
									<ScrollAnimation>
				<p className="text-gray-400 mb-12 max-w-2xl">
					My education is built on a strong foundation of self-learning, practical experience, and continuous skill development. Through formal studies, hands-on projects, and constant exploration of new technologies, I have developed the technical knowledge and problem-solving mindset needed to build real-world digital solutions. I believe learning never stops, and I actively invest in improving my skills to stay relevant in the fast-evolving tech industry.
				</p>
			</ScrollAnimation>
