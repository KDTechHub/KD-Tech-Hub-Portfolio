...
const About = () => {
	...
	return (
		<div className="min-h-screen pt-20 px-4 max-w-4xl mx-auto pb-20">
			<ScrollAnimation>
				<motion.h1 className="text-4xl font-bold mb-8 gradient-text">
					About Kuadugah Delight
				</motion.h1>
			</ScrollAnimation>
			
			<ScrollAnimation>
				<p className="text-gray-400 mb-12 max-w-2xl">
					Im Kuadugah Delight, a versatile Full-Stack Developer, tech entrepreneur, and digital solutions builder. I design, build, and scale web applications, software systems, and online businesses across multiple industries — from IT services and SaaS platforms to e-commerce, telecom solutions, and digital marketing ecosystems. My focus is on creating practical, scalable, and results-driven technology that solves real-world problems.
				</p>
			</ScrollAnimation>
			...
			<div className="grid md:grid-cols-2 gap-8">
				<ScrollAnimation>
					<div className="aspect-square overflow-hidden rounded-2xl">
						<img
							src="/profile/my_profile.jpg"
							alt="Kuadugah Delight"
				...
				<ScrollAnimation className="space-y-6">
					...
					<ScrollAnimation>
						<div className="pt-4">
							...
							<ul className="list-none space-y-3">
								{["Based in Ghana, Volta region", "B.Tech in Computer Science", "CGPA: 8.48"].map((fact, index) => (
									<motion.li
										key={fact}
					...
					<ScrollAnimation>
						<div className="flex justify-start space-x-4">
							<a
								href="/files/cv_pdf/Kuadugah_Delight(CV).pdf"
								target="_blank"
