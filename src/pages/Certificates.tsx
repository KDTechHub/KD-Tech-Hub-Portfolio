		...
		<div className="min-h-screen pt-20 px-4 max-w-6xl mx-auto pb-20">
			<ScrollAnimation>
				...
				>
					...
					<h2 className="text-4xl font-bold gradient-text">My Certificates & Achievements</h2>
				</motion.div>
			</ScrollAnimation>
			
			<ScrollAnimation>
				<p className="text-gray-400 mb-12 max-w-2xl">
					Explore the professional certifications and achievements I’ve earned over the years. These reflect my commitment to continuous learning, technical expertise, and dedication to delivering high-quality solutions in web and software development.
				</p>
			</ScrollAnimation>
